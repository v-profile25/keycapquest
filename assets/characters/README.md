...
`monkey`, `unicorn`, `koala`, `dog`, `cat`, `rabbit`, `bear`. Currently
illustrated: `dog` and `fox`, both with all three paths for tiers 6-10.
The rest fall back to emoji portraits until art is added.
